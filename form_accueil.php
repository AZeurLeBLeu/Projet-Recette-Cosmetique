    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="#" class="nav-link px-2 text-primary menue">Ajouter une recette</a></li>
          <li><a href="form_recetteAValider.php" class="nav-link px-2 text-primary menue"><?php afficherBouton(); ?></a></li>
        </ul>
